...
<script type="text/javascript" src="https://res.kurly.com/js/lib/jquery-1.10.2.min.js?ver=20191029141723"></script>
<link rel="shortcut icon" href="https://res.kurly.com/images/marketkurly/logo/favicon_v2.png" type="image/x-icon">
<script>
var jwtToken = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..dNaB70qG7IsM47BHXMSbD7o1tIHPi3ASYFH8PMVAR3w';
var apiDomain = 'https://api.kurly.com';
var GD_ISMEMBER = !!Number('0');
var checkIsApp = true;// 해당스크립트관련으로 앱체크공용변수추가 생성.앱에서 불필요한 호출제거
</script>
<script src="https://ssl.daumcdn.net/dmaps/map_js_init/postcode.v2.js?ver=20191029141723"></script>
<script src="https://www.kurly.com/shop/data/skin/designgj/thefarmers.js?ver=20191029141949"></script>
<script src="https://www.kurly.com/shop/data/skin/designgj/common.js?ver=20191029141949"></script>
<script src="https://www.kurly.com/shop/data/skin/designgj/polify.js?ver=20191029141949"></script>
<script src="https://www.kurly.com/shop/data/skin/designgj/ui_v2.js?ver=20191029142314"></script>
<script src="https://res.kurly.com/js/lib/jquery.lazyload.min.js?ver=20191029141723"></script>

<script src="//res.kurly.com/js/vue/xdomain.min.js" slave="https://api.kurly.com/xdomain"></script>

<script src="//res.kurly.com/js/vue/es6-promise.min.js?ver=20191029141723"></script>
<script src="//res.kurly.com/js/vue/es6-promise.auto.min.js?ver=20191029141723"></script>

<script type="text/javascript" src="//res.kurly.com/js/vue/axios.min.js?ver=20191029141723"></script>


<script src="//res.kurly.com/js/vue/vue.min.js?ver=20191029141723"></script>
<script src="https://www.kurly.com/common_js/axios.js?ver=20191029142405"></script>
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/normalize.css?ver=20191029141902">
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/section1.css?ver=20191029141902">
<link rel="styleSheet" href="https://www.kurly.com/shop/data/skin/designgj/common.css?ver=20191029141902">

<script type="text/javascript" src="//wcs.naver.net/wcslog.js"></script>
<script type="text/javascript" src="https://www.kurly.com/shop/lib/js/naverCommonInflowScript.js?Path=goods/goods_cart.php&amp;Referer=&amp;AccountID=s_4f41b5625072&amp;Inflow=kurly.com" id="naver-common-inflow-script"></script>
...
<script src="https://www.kurly.com/common_js/usermenu_v1.js?ver=20191029142405"></script>
<script>
$(document).ready(function(){
...
<script src="https://www.kurly.com/common_js/gnb_v1.js?ver=20191029142405"></script>
<script type="text/javascript">
//
gnbMenu.update();
...
<cart-item v-if="!product.is_package" :bus="bus" :parent-product="product" :product="product" :key="product.no" :type="type" :tag-name="product.tags.names" :tag-type="product.tags.tagType" @on-change-checked="onChangeChecked($event, product)" @update-price="updatePrice($event, product, false)" @on-delete="onDelete"></cart-item>
<cart-item v-if="product.is_package" v-for="(childProduct,idx) in product.products" :bus="bus" :name="product.name" :idx="idx" :parent-product="product" :product="childProduct" :key="childProduct.no" :type="type" :tag-name="childProduct.tags.names" :tag-type="childProduct.tags.tagType" :is-last-product="idx===product.products.length-1" @on-change-checked="onChangeChecked($event,childProduct)" @update-price="updatePrice($event, product, idx)" @on-delete="onDelete"></cart-item>
</template>
...
<script src="https://www.kurly.com/common_js/common_filter.js?ver=20191029142405"></script>
<script src="https://www.kurly.com/common_js/cart_v2.js?ver=20191029142405"></script>
<script>
viewCart.userGrade = "";
</script>
<script type="text/javascript">
